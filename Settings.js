...
const Settings = ({ visible, setVisible, userId, userLevel }) => {
  const [privPolVisible, setPrivPolVisible] = useState(false);
  const [tncVisible, setTncVisible] = useState(false);

  const handleExpiredClick = async () => {
    console.log(new Date().toISOString());
    try {
      const serverResponse = await fetch(`${EB_URL}/expiredGames`, {
        method: "DELETE",
      });
  ...
  const deletePGAccount = async () => {
    if (!userId) {
      return;
    }
    try {
      const serverResponse = await fetch(`${EB_URL}/deleteUser/${userId}`, {
        method: "DELETE",
      });
      const serverData = await serverResponse.json();
      if (serverData.msg == "user deleted") {
    ...
    >
      ...
      >
        ...
        <View style={{ marginTop: 20 }}>
          <Pressable onPress={() => setPrivPolVisible(!privPolVisible)}>
            {!privPolVisible ? (
              <Text
                style={{
                  color: "white",
            ...
            {privPolVisible ? (
              ...
              >
                ...
                <Text style={styles.bodyText}>
                  Brian Hill built the point.game app as a Free app. This
                  SERVICE is provided by Brian Hill at no cost and is intended
                  for use as is. This page is used to inform visitors regarding
                  my policies with the collection, use, and disclosure of
                  ...
                  at point.game unless otherwise defined in this Privacy Policy.
                </Text>
                ...
                <Text style={styles.bodyText}>
                  ...
                  information, including but not limited to email. The
                  information that I request will be retained on your device and
                  is not collected by me in any way. The app does use
        ...
        <View style={{ marginTop: 20, paddingBottom: 20 }}>
          <Pressable onPress={() => setTncVisible(!tncVisible)}>
            {!tncVisible ? (
              <Text
                style={{
                  color: "white",
          ...
          >
            {tncVisible ? (
              ...
              >
                <Text style={styles.headerText}>Terms & Conditons</Text>
                <Text style={styles.bodyText}>
                  ...
                  related to it, still belong to Brian Hill. Brian Hill is
                  ...
                  you’re paying for. The point.game app stores and processes
                  personal data that you have provided to us, to provide my
                  ...
                  that the point.game app won’t work properly or at all. The app
                  does use third-party services that declare their Terms and
                  Conditions. Link to Terms and Conditions of third-party
                  service providers used by the app: You should be aware that
                  there are certain things that Brian Hill will not take
                  ...
                  Brian Hill cannot take responsibility for the app not working
                  at full functionality if you don’t have access to Wi-Fi, and
                  you don’t have any of your data allowance left. If you’re
                  using the app outside of an area with Wi-Fi, you should
                  remember that the terms of the agreement with your mobile
                  ...
                  Along the same lines, Brian Hill cannot always take
                  responsibility for the way you use the app i.e. You need to
                  make sure that your device stays charged – if it runs out of
                  battery and you can’t turn it on to avail the Service, Brian
                  Hill cannot accept responsibility. With respect to Brian
                  Hill’s responsibility for your use of the app, when you’re
                  ...
                  us so that we can make it available to you. Brian Hill accepts
                  no liability for any loss, direct or indirect, you experience
                  ...
                  app. Brian Hill does not promise that it will always update
                ...
                <Text style={styles.bodyText}>
                  ...
                  are effective as of 2023-06-11
                </Text>
                <Text style={styles.headerText}>Contact Us</Text>
                <Text style={styles.bodyText}>
        ...
        {userLevel !== "Administrator" ? null : (
          <View style={{ marginBottom: 50 }}>
            <Pressable onPress={() => handleExpiredClick()}>
              <Text
                style={{
                  color: "white",
                  textAlign: "center",
